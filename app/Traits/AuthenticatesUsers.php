...
trait AuthenticatesUsers
{
    ...
    protected function sendLoginResponse(Request $request)
    {
        ...
        // dump($request->session()->get('url.intended'));
        // dd($user);
        ...
        return redirect('/admin/roles')->withSuccess('Signed in');
        return redirect()->intended('/admin/roles')->withSuccess('Signed in');
        return redirect()->route('admin.roles.index')->with('message', "YO");
