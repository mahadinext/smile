...
@section('content')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <form method="POST" action="{{ route("teacher.profile.update", $teacher->id) }}" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <input id="email" name="email" type="text" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ old('email', $teacher->email ?? '') }}" autocomplete="email" autofocus disabled required>
                                            @if($errors->has('email'))
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control {{ $errors->has('phone_no') ? 'is-invalid' : '' }}" type="text" name="phone_no" id="phone_no" value="{{ old('phone_no', $teacher->phone_no ?? '') }}" required>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <input id="first_name" name="first_name" type="text" class="form-control {{ $errors->has('first_name') ? ' is-invalid' : '' }}" value="{{ old('first_name', $teacher->first_name ?? '') }}" autofocus required>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control {{ $errors->has('dob') ? 'is-invalid' : '' }}" name="dob" id="dob" value="{{ old('dob', $teacher->dob ?? '') }}" required>
                                            @if($errors->has('dob'))
                                                <div class="invalid-feedback">
                                                    {{ $errors->first('dob') }}
                                                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address" id="address">{{ old('address', $teacher->address ?? '') }}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <input id="experience" name="experience" type="text" class="form-control {{ $errors->has('experience') ? ' is-invalid' : '' }}" value="{{ old('experience', $teacher->experience ?? '') }}" required>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control {{ $errors->has('bio') ? 'is-invalid' : '' }}" name="bio" id="bio">{{ old('bio', $teacher->bio ?? '') }}</textarea>
                                            @if($errors->has('bio'))
                                                <div class="invalid-feedback">
                                                    {{ $errors->first('bio') }}
                                                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control {{ $errors->has('detailed_info') ? 'is-invalid' : '' }} ckeditor-classic" name="detailed_info" id="detailed_info">{{ old('detailed_info', $teacher->detailed_info ?? '') }}</textarea>
